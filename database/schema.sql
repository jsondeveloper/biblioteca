...
CREATE TABLE IF NOT EXISTS prestamos (
    ...
    estado ENUM('Activo','Devuelto','Retrasado','Devolucion Retrasada') NOT NULL DEFAULT 'Activo',
...
CREATE TABLE IF NOT EXISTS prestamos_historial (
    ...
    estado_anterior ENUM('Activo','Devuelto','Retrasado','Devolucion Retrasada') NOT NULL,
    estado_nuevo ENUM('Activo','Devuelto','Retrasado','Devolucion Retrasada') NOT NULL,
